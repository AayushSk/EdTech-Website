                    ...
                    <li key={index}>
                        {
                            link.title === "Catalog" ? (
                                <div className={`group relative flex cursor-pointer items-center gap-1 ${
                                    ...
                                    translate-x-[-50%] translate-y-[35%] flex flex-col w-[200px]
                                    rounded-md bg-richblack-5 p-4 text-richblack-900 opacity-0 transition-all duration-200
                                    group-hover:visible group-hover:translate-y-[1.65em] group-hover:opacity-100 lg:w-[250px] z-[10]'>

                                    <div className='absolute left-[54%] translate-x-[40%] translate-y-[-35%] top-0 h-6 w-6 rotate-45
                                    bg-richblack-5 z-[-1]'>
                                    </div>

                                    {
                                        loading ? (<div className='text-center'>Loading...</div>) 
                                        : (subLinks && subLinks.length) ? (subLinks.map( (subLink, index) => (
