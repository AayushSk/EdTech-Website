...
const ExploreMore = () => {
  ...
  return (
    <div>
      ...
      <div className='hidden lg:flex flex-row rounded-full font-medium bg-richblack-800 mb-5 mt-5 border-richblack-200 px-1 py-1 drop-shadow-[0_1.5px_rgba(255,255,255,0.25)]'>
        {
