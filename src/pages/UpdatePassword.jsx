    ...
    <div className="grid min-h-[calc(100vh-3.5rem)] place-items-center">
      {
        loading ? (
            ...
            <div className="max-w-[500px] p-4 lg:p-8">
                ...
                <p className="my-4 text-[1.125rem] leading-[1.625rem] text-richblack-100">Almost done. Enter your password and you are all set.</p>
                ...
                <div className="mt-6 flex items-center justify-between">
                    <Link to="/login">
                        <p className="flex items-center gap-x-2 text-richblack-5"><BiArrowBack></BiArrowBack> Back to Login</p>
                    </Link>
                </div>
            </div>
        )
