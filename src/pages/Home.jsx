    ...
    <div>
      ...
      text-white justify-between gap-8'>
        ...
        <div className='mt-4 w-[90%] text-center text-lg font-bold text-richblack-300'>
            With our online coding courses, you can learn at your own pace, from anywhere in the world and got access to a wealth of resources, including hands-on projects, quizzes, and personalized feedback from instructors.
        </div>
        ...
        <div>
            ...
            heading={
                <div className='text-4xl font-semibold lg:w-[50%] w-[100%]'>
                    Start
      ...
      {/* Section 3 */}
      <div className='relative w-11/12 mx-auto my-20 max-w-maxContent flex-col items-center justify-between gap-8
